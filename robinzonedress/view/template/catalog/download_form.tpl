        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div style="margin-bottom: 5px;" class="input-group"> <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php foreach ($languages as $language) { ?>
                        <div style="margin-bottom: 5px;" class="input-group"> <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                            <input type="text" name="download_description[<?php echo $language['language_id']; ?>][description]" value="<?php echo isset($download_description[$language['language_id']]['description']) ? $download_description[$language['language_id']]['description'] : ''; ?>" placeholder="<?php echo $entry_description; ?>" class="form-control" />
                        </div>
                    <?php } ?>
                </div>
            </div>
