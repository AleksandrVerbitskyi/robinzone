  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
          <a target="_blank" href="<?= $run_import; ?>" data-toggle="tooltip" title="<?= $button_run_import; ?>" class="btn btn-default" style="background-color: #eec73a;"><i class="fa fa-refresh"></i></a>
