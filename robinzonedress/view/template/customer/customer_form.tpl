                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-thirdname"><?php echo $entry_thirdname; ?></label>
                            <div class="col-sm-10">
                                <input type="text" name="thirdname" value="<?php echo $thirdname; ?>" placeholder="<?php echo $entry_thirdname; ?>" id="input-thirdname" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-birthday"><?php echo $entry_birthday; ?></label>
                            <div class="col-sm-10">
                                <input type="text" name="birthday" value="<?php echo $birthday; ?>" placeholder="<?php echo $entry_birthday; ?> (mask: day-month-year)!" id="input-birthday" class="form-control" />
                            </div>
                        </div>
                      <div class="form-group required">
