        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> <?= $text_list_warehouses; ?></h3>
                </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php if ($sort == 'name') { ?>
                                        <a href="<?= $sort_name; ?>" class="<?= strtolower($order); ?>"><?= $column_warehouse_name; ?></a>
                                    <?php } else { ?>
                                        <a href="<?= $sort_name; ?>"><?= $column_warehouse_name; ?></a>
                                    <?php } ?></td>
                                <td class="text-right"><?= $column_warehouse_ref; ?></td>
                                <td class="text-right"><?= $column_warehouse_type; ?></td>
                            </tr>
                            </thead>
                            <tbody>
                            <?php if ($warehouses) { ?>
