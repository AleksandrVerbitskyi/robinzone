...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
        ...
        $data['button_run_import'] = $this->language->get('button_run_import');
        $data['run_import'] = $this->url->link('extension/module/integration_with_1c', 'token=' . $this->session->data['token'] . $url, true);
