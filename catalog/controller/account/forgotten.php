...
class ControllerAccountForgotten extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('account/forgotten_success', '', true));
		}
		...
		$data['text_button_forgotten_success'] = $this->language->get('text_goto_catalog');
		...
		$data['back'] = $this->url->link('product/category', '', true);
