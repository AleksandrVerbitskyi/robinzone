...
$_['text_checkout_option']           = 'Контактные данные';
$_['text_checkout_shipping_payment'] = 'Доставка и оплата';
$_['text_checkout_comments']         = 'Комментарии к заказу';
...
$_['text_checkout_confirm']          = 'Заказать и оплатить';
...
$_['text_agree']                     = 'Мною прочитан и я даю согласие с документом <a href="%s" class="agree"><b>%s</b></a>';
...
$_['text_shipping_method']           = 'Выберите варианты доставки';
$_['text_payment_method']            = 'Выберите варианты оплаты';
$_['text_comments']                  = 'Ваш комментарий';
...
$_['entry_newsletter']               = 'Подписаться на рассылку новостей %s';
...
$_['error_area'] = 'Вам необходимо выбрать регион для доставки!';
$_['error_city'] = 'Вам необходимо выбрать город для доставки!';
$_['error_warehouse'] = 'Вам необходимо выбрать отделение для доставки!';