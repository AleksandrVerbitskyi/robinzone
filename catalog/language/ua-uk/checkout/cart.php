...
$_['text_items']               = 'У кошику <span>%s</span> товар(и/ів)';
...
$_['error_maximum']            = 'Максимальна кількість товару %s шт.!';
...
$_['error_options'] = 'Виберіть опції для товара!';
